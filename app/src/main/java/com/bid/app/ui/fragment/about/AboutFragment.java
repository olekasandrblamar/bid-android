...
public class AboutFragment extends BaseFragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        ((DashboardActivity) requireActivity()).setTitleAndImage(getResources().getString(R.string.title_about_bid), R.drawable.ic_back_arrow, false);
    ...
    private void callAboutBIDApi() {

        CustomProgressDialog.getInstance().showDialog(requireActivity(), true);

        final Call<StaticPageResponse> call = apiInterface.aboutBID();
