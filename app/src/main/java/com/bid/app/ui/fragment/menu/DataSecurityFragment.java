...
public class DataSecurityFragment extends BaseFragment {

    private static final String TAG = DataSecurityFragment.class.getSimpleName();
    ...
    private void callDataSecurityApi() {
        ...
        final Call<StaticPageResponse> call = apiInterface.dataSecurity();
