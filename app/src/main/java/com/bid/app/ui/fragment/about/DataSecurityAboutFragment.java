...
public class DataSecurityAboutFragment extends BaseFragment {

    private static final String TAG = DataSecurityAboutFragment.class.getSimpleName();
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.fragment_data_security, container, false);

        apiInterface = APIClient.getClient().create(APIInterface.class);

        ((DashboardActivity) requireActivity()).setTitleAndImage(getResources().getString(R.string.title_download_data), R.drawable.ic_back_arrow, false);
    ...
    private void callDataSecurityApi() {
