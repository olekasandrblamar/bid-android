...
public class BuyTicketCashFragment extends BaseFragment {
    ImageView qrCode;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.fragment_transport_buy_ticket_cash, container, false);
    ...
    private Boolean validationCheck() {
        if(cash.getText().toString().length() == 0) {
            AlertUtils.showAlerterWarning(requireActivity(), "Please enter Cash amount");
