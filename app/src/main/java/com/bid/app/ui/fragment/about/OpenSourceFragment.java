...
public class OpenSourceFragment extends BaseFragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        ((DashboardActivity) requireActivity()).setTitleAndImage(getResources().getString(R.string.title_open_source), R.drawable.ic_back_arrow, false);
    ...
    private void callOpenSourceApi() {
