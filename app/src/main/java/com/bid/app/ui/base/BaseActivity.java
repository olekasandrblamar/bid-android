...
public class BaseActivity extends AppCompatActivity implements View.OnClickListener, IRecyclerViewClickListener {
    ...
    @Override
    public void clickOnSchedule(int position,  Ticket obj) {
    ...
    @Override
    public void clickFamilyData(int position, FamilyData idDocument) {
