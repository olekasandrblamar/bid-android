...
public class PrivacyPolicyFragment extends BaseFragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        ((DashboardActivity) requireActivity()).setTitleAndImage(getResources().getString(R.string.title_privacy_policy), R.drawable.ic_back_arrow, false);
    ...
    private void callPrivacyPolicyApi() {
        ...
        final Call<StaticPageResponse> call = apiInterface.privacyPolicy();
