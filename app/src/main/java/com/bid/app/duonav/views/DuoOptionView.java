package com.bid.app.duonav.views;
...
public class DuoOptionView extends RelativeLayout {
    ...
    public void bind(String title, @Nullable int selectorDrawable, @Nullable Drawable selectorSideDrawable) {
        mOptionViewHolder.mTextViewOption.setText(title);
        mOptionViewHolder.mTextViewOption.setAlpha(ALPHA_UNCHECKED);
